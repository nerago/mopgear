...
public class SolverRandom {
    public static Optional<SolvableItemSet> runSolver(ModelCombined model, SolvableEquipOptionsMap items, StatBlock adjustment, Instant startTime, long count, Predicate<SolvableItemSet> specialFilter) {
